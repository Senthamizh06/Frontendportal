...
const ResearchLabForm = () => {
  ...
  const handleCreate = () => {
    // Logic to handle creation of the research lab
  ...
  const handleDelete = () => {
    // Logic to handle deletion of the research lab
    console.log('Deleting research lab');
  };

  return (
    <div className="form-container">
      <h2>Create Research Lab</h2>
      ...
      <div className="button-group">
        <button onClick={handleCreate}>Create Research Lab</button>
        <button onClick={handleDelete}>Delete Research Lab</button>
      </div>
    </div>
  );
};
